...
public class Config {
         ...
         */
        public static final String ERROR_SEED_NOT_IN_INTERVAL = ERROR
         ...
         * already planted
         */
        public static final String ERROR_ALREADY_PLANTED = ERROR + "Something is already planted in the field!";
        /**
         * Error message in case a player tries to plant a wrong vegetable type on a
         * field
         */
        public static final String ERROR_WRONG_VEGETABLE_TYPE = ERROR
                        + "You can't plant this vegetable on this field type!";
        /**
         * Error message in case a player tries to plant a vegetable they doesn't have
         */
        public static final String ERROR_TILE_STACK_EMPTY = ERROR + "There is no more land to buy!";
