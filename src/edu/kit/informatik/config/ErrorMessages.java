...
/**
 * Class with all error messages used in queens farming
 * 
 * @author uiljo
 * @version 1.0
 */
public final class ErrorMessages {
     ...
     * Error message in case all tiles are taken
     */
    public static final String HARVEST_MORE_THEN_PLANTED = GeneralConfig.ERROR
            + "Amount to harvest can't be bigger than amount of planted vegetables!";
